//Die Datei kann nicht auf ID von der socketio.html Datei zugreifen 
/**
...
function parseResult() {
  ...
  document.getElementById("valuespeak").innerHTML = "Test"; //Warum funktioniert das nicht??
  if (mostRecentPhrase == "test") {
    console.log ("sucess");
  }
}
